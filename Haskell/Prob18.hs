--main= do
--      fmap (\y -> map (\x -> read x :: Int) (words y)) (readFile "Prob18file.txt")
...
freeTree :: Tree Int
freeTree = Node 3 (Node 7 (Node 2 (Node 8 Empty Empty) (Node 5 Empty Empty) ) (Node 4 (Node 4 Empty Empty) (Node 6 Empty Empty) ) ) (Node 4 (Node 4 (Node 5 Empty Empty) (Node 9 Empty Empty) ) (Node 6 (Node 9 Empty Empty) (Node 3 Empty Empty)))

treeMaker :: Int -> [Int] -> Tree Int
treeMaker (x) [a,b] = Node x (Node a (Empty) (Empty)) (Node b (Empty) (Empty))
